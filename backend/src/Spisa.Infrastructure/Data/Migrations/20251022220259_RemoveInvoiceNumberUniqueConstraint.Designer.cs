...
namespace Spisa.Infrastructure.Data.Migrations
{
    ...
    [Migration("20251022220259_RemoveInvoiceNumberUniqueConstraint")]
    partial class RemoveInvoiceNumberUniqueConstraint
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Spisa.Domain.Entities.Article", b =>
                {
                    ...
                    b.Property<decimal?>("HistoricalPrice1")
                        .HasPrecision(18, 2)
            ...
            modelBuilder.Entity("Spisa.Domain.Entities.SalesOrder", b =>
                {
                    ...
                    b.Property<decimal>("SpecialDiscountPercent")
                        .HasColumnType("numeric")
                        .HasColumnName("special_discount_percent");
